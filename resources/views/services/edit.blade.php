                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-12">
                                <div class="form-group mb-3">
                                    ...
                                    @if($servicio->image)
                                        <div class="mb-2">
                                            <img src="{{ asset($servicio->image) }}" alt="Imagen actual" class="img-thumbnail" style="max-width: 200px; max-height: 200px;">
                                            <p class="text-muted small">Imagen actual</p>
                                        </div>
                                    @endif
                                    <input type="file" class="form-control @error('image') is-invalid @enderror" id="image" name="image" accept="image/*">
                                    <small class="form-text text-muted">Formatos permitidos: JPEG, PNG, JPG, GIF. Máximo 2MB. Deja vacío para mantener la imagen actual.</small>
                                    @error('image')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
