            ...
            <div class="row align-items-center">
                <div class="col-md-8">
                    <h1 class="header-title">
                        <i class="fas fa-plus-circle me-3"></i>Crear Departamento
                    </h1>
                    <p class="header-subtitle">Formulario para registrar un nuevo departamento</p>
                </div>
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-md-end">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">
                                <i class="fa-solid fa-plus me-1"></i>Crear Departamento
                            </li>
                        </ol>
                    </nav>
                </div>
