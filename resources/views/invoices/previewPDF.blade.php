            ...
            <table width="100%">
                 <tr>
                    ...
                    <td align="right" style="width: 50%;padding-left:20px;padding-right:45px">
                         <img src="{{ public_path($empresa->logo) }}" alt="Logo" width="200" class="logo"/>
                ...
                <table width="100%">
                    <tr>
                        <td align="left" style="width: 40%;padding-left:20px;vertical-align:top;">
                            ...
                            {{-- <p style="font-size:12px">Campaña: <span style="padding-left:17px;">{{ optional($invoice->project)->name }}</span></p> --}}
                    ...
                    <div style="page-break-after: avoid; height: 140px;padding-left:35px">
                        ...
                        <table id="summary" style="border-collapse: collapse;width: 100%;">
                            <tr>
                                ...
                                <th style="text-align:center">Retención {{ $invoice->retencion_percentage }}%</th>
                            ...
                            <tr>
                                ...
                                <td style="text-align:center">{{ $invoice->retencion }}&nbsp;€</td>
