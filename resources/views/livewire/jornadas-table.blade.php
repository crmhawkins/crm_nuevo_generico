        ...
        <div class="table-responsive">
             <table class="table table-hover">
                <thead class="header-table">
                    ...
                    <th>
                        <a href="#" wire:click.prevent="sortBy('start_time')">
                            INICIO
                ...
                <tbody>
                    ...
                    <tr class="clickable-row" data-href="{{route('horas.edit', $nomina->id)}}">
                            <td>{{$nomina->user ? ($nomina->user->name.' '.$nomina->user->surname) : 'Usuario no encontrado'}}</td>
                            <td>{{ \Carbon\Carbon::parse($nomina->start_time)->format('d/m/Y H:i') }}</td>
                            <td>{{ \Carbon\Carbon::parse($nomina->end_time)->format('d/m/Y H:i') }}</td>
                            <td class="flex flex-row justify-evenly align-middle" style="min-width: 120px">
                                <a class="" href="{{route('horas.edit', $nomina->id)}}"><img src="{{asset('assets/icons/edit.svg')}}" alt="Editar nomina"></a>
...
@section('scripts')
    ...
    <script>
        ...
        function botonAceptar(id){
            ...
            Swal.fire({
                title: "¿Estas seguro que quieres eliminar esta jornada?",
