                            ...
                            <tbody>
                                @foreach ( $usuario->tareas->whereIn('task_status_id', [1, 2]) as $tarea )
                                    <tr @if($tarea->task_status_id == 1) style="background-color: #7ede6d;" @endif>
                                        ...
                                        <td @if($tarea->task_status_id == 1) style="background-color: #7ede6d;" @endif>{{$tarea->presupuesto ? ($tarea->presupuesto->cliente ? $tarea->presupuesto->cliente->name : 'Cliente Borrado') : 'Pre-factura Borrada'}}</td>
