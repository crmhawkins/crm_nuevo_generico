...
class UserController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $this->validate($request, [
            ...
            'pin' => 'required|string|size:4|regex:/^[0-9]{4}$/|unique:admin_user',
            ...
            'pin.required' => 'El PIN es requerido para continuar',
            'pin.size' => 'El PIN debe tener exactamente 4 dígitos',
            'pin.regex' => 'El PIN debe contener solo números',
            'pin.unique' => 'Este PIN ya está en uso por otro usuario',
    ...
    public function update(Request $request, string $id)
    {
        $this->validate($request, [
            ...
            'pin' => 'required|string|size:4|regex:/^[0-9]{4}$/|unique:admin_user,pin,' . $id, // Permitir el mismo PIN si pertenece al usuario actual
            'access_level_id' => 'required|exists:admin_user_access_level,id',
            'admin_user_department_id' => 'required|exists:admin_user_department,id',
            'admin_user_position_id' => 'required|exists:admin_user_position,id',
        ], [
